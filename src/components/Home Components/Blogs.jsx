                ...
                <div className="card-body">
                  ...
                  <div className="d-flex">
                    <button
                      ...
                      aria-controls={`offcanvasBottom-${index}`}
                    >
                      Read More
                    </button>
                  </div>
                ...
                >
                  <div class="offcanvas-header mx-4 mt-5">
                    <div className="ms-2">
                      ...
                      <p className="small disabled mx-1 my-2">
                        By {blog.author.name} <p>On {blog.date}</p>
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <hr className="m-0" />
                  <div class="offcanvas-body px-5 py-4">{blog.ogContent}</div>
                </div>
              </div>
            ))}
          </div>
