...
const Profile = () => {
    ...
    const [editedProfile, setEditedProfile] = useState({
        ...
        profilePic: `${BASE_URL}/uploads/${profileInfo.profilePic}`,
    });
                    ...
                    <div className="card bg-dark" style={{ width: "18rem" }}>
                        {
                            ...
                            preview ?
                                ...
                                :
                                <img src={editedProfile.profilePic} className="card-img-top" alt="Profile" />
                        ...
                        {isEditing ?
                            ...
                            <div className='px-4'>
                                <input className='form-control mt-4 mb-2' type="file" name="profilePic" id="" onChange={setProfile} />
                            </div>
                            :
                        ...
                        <div className="pb-4">
                            {isEditing ? (
                                ...
                                <h3 className="text-center text-uppercase card-title">{editedProfile.name}</h3>
                            )}
                        </div>
                        ...
                        <div className="card-body d-flex justify-content-evenly mt-3">
                            <div>
                                {isEditing ?
                                    <div className='d-flex justify-content-evenly gap-3 mx-auto '>
                                        ...
                                        <button className="btn btn-outline-danger text-danger" onClick={handleCancel}>
                                            Cancel
                                        </button>
                                    </div>
                                    :
                            ...
                            <div className=''>
                                {!isEditing ? <button className='btn btn-outline-danger text-danger' onClick={deleteAccount}>Delete</button> : ''}
                            </div>
                        </div>
